...
import com.jinqiu.zombieattack.view.component.object.cycleplay.ZombieKillerCyclePlay;

public class ViewZombieKillerFactory implements ViewExpirableObjectFactory {
	...
	public ViewExpirableObject getViewExpirableObject(
		...
		return new ViewMovingExpirableObject(expirableObject,
				new ZombieKillerCyclePlay(expirableObject.getObjectState()),
